...
def menu():
    with st.sidebar:
        ...
        expn_b.caption("Tujuan penelitian ini secara umum untuk mengetahui hasil prediksi sebaran emisi karbon sebagai indikator hotspot 2021, 2022, 2023 berupa nilai dan visualisasi hasil dari penggunaan Machine Learning dengan model Random Forest Regression dan dan Gradient Boosting Regression, dengan kasus prediksi sebaran emisi karbon sebagai indikator hotspot yang dihasilkan untuk wilayah Sumatra. Tujuan penelitian sebagai berikut:\n 1.	Membandingkan algoritma Supervised Learning model Random Forest Regression dan Gradient Boosting Regression dalam memprediksi emisi karbon sebagai indikator hotspots kebakaran hutan untuk studi kasus wilayah Sumatra. \n2.	Mengetahui indikator iklim apa saja yang memilki kolerasi paling tinggi terhadap penyebaran emisi karbon sebagai indikator hotspot, dan persentase kontribusi dalam model. \n3.	Menggunakan bahasa pemorgraman python untuk implementasi memprediksi emisi karbon sebagai hotspot menggunakan model Random Forest Regression dan Gradient Boosting Regression.")
